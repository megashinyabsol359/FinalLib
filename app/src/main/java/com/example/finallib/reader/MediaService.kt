...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: com.example.finallib.main.Application
            get() = application as com.example.finallib.main.Application
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as com.example.finallib.main.Application).readerRepository
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "com.example.finallib.reader.MediaService"
