...
package com.example.finallib.outline
...
import com.example.finallib.databinding.FragmentOutlineBinding
import com.example.finallib.reader.ReaderActivity
import com.example.finallib.reader.ReaderViewModel
import com.example.finallib.utils.viewLifecycle

class OutlineFragment : Fragment() {
    // Ensure you are using the 'activityViewModels' delegate
    // so it shares the SAME instance as the Activity/ReaderFragment
    private val viewModel: ReaderViewModel by activityViewModels()

    override fun onDetach() {
        super.onDetach()
        // This is called when the fragment is being removed
        viewModel.outlineClosed()
    }
